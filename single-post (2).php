                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 col-md-9">
                        <div class="blog-posts-area">
                            ...
                            $query = "select * from post where id=" . $_GET['p'] . " and cancel='0' order by sdate desc";

                            foreach ($conn->query($query) as $row) {
                                $content = " <div class='single-post-details-area'>
                                <div class='post-content'>
                                    <h4 class='post-title'>" . substr($row['name'], 0, 50) . "</h4>
                                ...
                                <img style='width:398px;height:290px;' src = admin/" . $row['pic'] . " alt = ''>
                                </div>
                                <p>" . $row['description'] . "<p/>
                                </div>
                                </div>";
