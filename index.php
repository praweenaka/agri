    ...
    <section class="new-arrivals-products-area   section-padding-100">
        <div class="container">
            ...
            <div class="row">
                ...
                $content = "";
                include './admin/connection_sql.php';
                $query = "select * from item  order by sdate limit 8";
                    ...
                    $content .= "   <div class='col-12 col-sm-6 col-lg-3'  >
                                    <div class='single-product-area mb-50 wow fadeInUp' data-wow-delay='400ms'>
                                        ...
                                        <div class='product-img'>
                                            <a   title='Portfolio 1'><img src=admin/" . $row['pic'] . "   ></a>
                                            <!-- Product Tag -->
                                            ...
                                            <div class='product-meta d-flex'>
                                                ...
                                                <a onclick='cart1(" . $row['id'] . ");' class='add-to-cart-btn'>Add to cart</a>
