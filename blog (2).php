                ...
                <div class="row">
                    <div class="col-12 col-md-9">
                        <div class="row">
                            ...
                            $query = "select * from post where cancel='0' order by   sdate desc";
                            ...
                            <div class='col-12 col-lg-6'>
                                <div class='single-blog-post mb-50'>
                                    <div class='post-thumbnail mb-30'>
                                         <a href='single-post.php?p=" . $row['id'] . "'><img style='width:398px;height:290px;' src=admin/" . $row['pic'] . " alt=''></a>
                                    </div>
                        ...
                        <div class="post-sidebar-area">
                            ...
                            <div class="single-widget-area">
                                ...
                                <div id="searchdiv">
                                    ...
                                    $content = "";
                                    include './admin/connection_sql.php';
                                    $query = "select * from post where cancel='0' order by sdate desc limit 25";
