...
//            echo "The file " . basename($_FILES["file"]["name"]) . " has been uploaded.";
        ...
        $sql = "insert into item(code, name, category, price, sdate, pic,user,uniq,descrip) values
                ('" . $_POST ['code'] . "','" . $_POST ['name'] . "', '" . $_POST ['category'] . "','" . $_POST ['price'] . "', '" . date("Y-m-d H:i:s") . "', '" . $target_file . "','" . $_SESSION["CURRENT_USER"] . "','" . $_POST ['uniq'] . "','" . $_POST ['descrip'] . "')";
        // echo $sql;
        $result = $conn->query($sql);
