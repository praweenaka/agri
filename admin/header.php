...
function get_title($url) {
    ...
    if ($url == "user_item_approve") {
        return 'User Item Approve';
        exit();
    }
}
?>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <header class="main-header">
                <!-- Logo -->
                <a href="home.php" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels --> <span class="logo-mini"><b>AG</b>RI</span> <!-- logo for regular state and mobile devices --> <span class="logo-lg"><b>Agri</b></span> </a>
