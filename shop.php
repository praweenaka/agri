                        ...
                        <div class="shop-sidebar-area">
                            ...
                            <div class="shop-widget catagory mb-50">
                                ...
                                <div class="widget-desc">
                                    ...
                                    $query = "select count(category) as count,category from item group by category";

                                    foreach ($conn->query($query) as $row) {
                                        $content = "  <div class='custom-control custom-checkbox d-flex align-items-center mb-2'>
                                                        <input type='checkbox' onClick=\"catsearch('" . $row['category'] . "')\" class='custom-control-input' id=" . $row['category'] . " name=" . $row['category'] . ">
                                ...
                                <div class="widget-desc">
                                    ...
                                    foreach ($conn->query($query) as $row) {
                                        ...
                                        <div class='product-info'>
                                            ...
                                            <p href='shop-details.php?var=" . $row['id'] . "'  >$" . $row['price'] . "</p>
                                            <div class='ratings'>
                        ...
                        <div class="shop-products-area">
                            <div class="row" id="itemdetails">
                                ...
                                foreach ($conn->query($query) as $row) {
                                    ...
                                    $content .= "    <a href='shop-details.php'><img src=admin/" . $row['pic'] . " alt=''></a>";
